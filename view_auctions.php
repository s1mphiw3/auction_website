	 ...
	 <li class="nav-item">
	  ...
	  <form class="d-flex">
		...
		<?php
			...
			include("connect.php");
			$stm_auction = "select * from auction_items";
			$result = mysqli_query($conn,$stm_auction);
						...
						$prod = mysqli_fetch_assoc($res);
						 echo "<div class='gallery'>";
							...
							echo "<div class='content'>";
								...
								$time = $sec/3600;
								 echo "<h3> Time Elapsed " . $time." minutes</h3>";
        ...
        $('#close-btn').click(function(){
         $('#show_image_popup').fadeOut();
			...
			{
				echo "<script> alert('No Current Running Auctions'); </script>";
